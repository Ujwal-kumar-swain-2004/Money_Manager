        ...
        <div className="w-64 h-[calc(100vh-61px)] bg-[#1f2a24] text-white border-r border-white/14 p-4 sticky top-[61px] z-20">
            ...
            {SIDE_BAR_DATA.map((item, index) => (
                <button
                    ...
                    key={`menu_${index}`}
                    className={`cursor-pointer w-full flex items-center gap-3 text-[14px] py-3 px-4 rounded-md mb-2 transition ${activeMenu == item.label ? "text-[#1f2a24] bg-[#d9ff72]": "text-white/78 hover:text-white hover:bg-white/10"}`}>
